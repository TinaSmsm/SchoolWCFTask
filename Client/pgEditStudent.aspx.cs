...
namespace Client
{
    public partial class pgEditStudent : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (Request.QueryString.Keys.Count != 0)
                {
                    ...
                    {
                        Session["RedirectedID"] = Request.QueryString["ID"].ToString();
                        lblID.Text = Session["RedirectedID"].ToString();
                    }
                    ...
                    if (Request.QueryString["Courses"] != null)
                    {
                        ...
                        {
                            if (Coursesarr[i].ToString() != ""&& Coursesarr[i].ToString() != "&nbsp;")
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                student.ID = int.Parse(lblID.Text.ToString());
                ...
                student.Courses.TrimEnd(',');
                client.EditStudent(student);
